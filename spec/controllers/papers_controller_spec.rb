...
describe PapersController do
  ...
  def valid_attributes
    { 
      :title => "Title of a paper about networks", 
      :year => 2000
    }
  end
  ...
  describe "GET index" do
    it "assigns all papers as @papers" do
      ...
      assigns(:records).should eq([paper])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested paper as @paper" do
      ...
      assigns(:record).should eq(paper)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new paper as @paper" do
      ...
      assigns(:record).should be_a_new(Paper)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created paper as @paper" do
        post :create, {:record => valid_attributes}, valid_session
        assigns(:record).should be_a(Paper)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved paper as @paper" do
        ...
        post :create, {:record => { "title" => "invalid value" }}, valid_session
        assigns(:record).should be_a_new(Paper)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested paper" do
        ...
        put :update, {:id => paper.to_param, :record => { "title" => "MyString" }}, valid_session
      end

      it "assigns the requested paper as @paper" do
        paper = Paper.create! valid_attributes
        put :update, {:id => paper.to_param, :record => valid_attributes}, valid_session
        assigns(:record).should eq(paper)
      end
    ...
    describe "with invalid params" do
      it "assigns the paper as @paper" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Paper.any_instance.stub(:save).and_return(false)
        put :update, {:id => paper.to_param, :record => { "title" => "a" * 256 }}, valid_session
        assigns(:record).should eq(paper)
      end
